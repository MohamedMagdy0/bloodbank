    ...
    <section class="container">
        <div class="card">
            <div class="card-header text-center">
                <h3>Cities Trash : {{ count($cities) }}</h3>
            </div><!-- card-header -->
                   ...
                   @foreach ($cities as $city)
                       ...
                       <tr>
                          <td>{{ $cities->FirstItem()+$loop->index}}</td>
                           <td>{{ $city->name }}</td>
                           <td><a href="{{ route('cities.restore', ['id'=>$city->id]) }}" class="btn btn-sm btn-success">Restore</a></td>
              ...
              <button type="submit" class="btn btn-default">Delete</button>
                ...
                @else
                   <div class="alert alert-dark text-center ">
                        <h1 class="text-capitalize">Sorry No Cities Trashed</h1>
                    </div><!-- alert elseif -->
                @endif
